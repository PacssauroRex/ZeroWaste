...
public class EditPromotionServiceTest {
    ...
    @Test
    @DisplayName("Deve atualizar corretamente o preço promocional dos produtos")
    void itShouldUpdatePromotionalPriceOfProducts() throws PromotionNotFoundException, ProductNotFoundException, InvalidDatePeriodException {
        // Arrange
        Long id = 1l;
        Long productId = 1l;
